...
![[Pasted image 20250601133824 1.png]]
...
Same deal, is the expected return starting from state s and following policy $\pi$  $$v_\pi(s) = \mathbb{E}_\pi[G_t \mid S_t = s]$$**Action Value Function:**
...
For any MDP,
- AVF is stored as a dictionary mapping a state(tuple) and the returns you get following every action possible (list of floats)
